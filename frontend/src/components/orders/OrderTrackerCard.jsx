...
const STEPS = [
  {
    key: 'empaquetant',
    label: 'Empaquetant',
    icon: '/steps/step-empaquetant.webp',
    iconDone: '/steps/step-empaquetant-done.webp',
  },
  {
    key: 'en_enviament',
    label: 'En enviament',
    icon: '/steps/step-enviament.webp',
    iconDone: '/steps/step-enviament-done.webp',
  },
  {
    key: 'entregada',
    label: 'Entregada',
    icon: '/steps/step-entregada.webp',
    iconDone: '/steps/step-entregada-done.webp',
  },
]
